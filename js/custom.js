...
function coachingCarousel () {
    if ($('.life-coaching-carousel').length) {
        $('.life-coaching-carousel').owlCarousel({
            dots: true,
            loop:true,
            margin:0,
            nav:false,
...
//=== experience box Carousel ===
function experienceboxCarousel () {
    if ($('.experience-box').length) {
        $('.experience-box').owlCarousel({
            dots: false,
            loop:true,
            margin:0,
